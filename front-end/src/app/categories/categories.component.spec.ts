...
describe('CategoriesComponent', () => {
  ...
  const createCategoryTree = function () {
    const cat11 = new Category({id: 1, name: 'Cat1.1', children: []});
    const cat12 = new Category({id: 2, name: 'Cat1.2', children: []});
    const cat1 = new Category({id: 3, name: 'Cat1', children: [cat11, cat12]});
    const cat2 = new Category({id: 4, name: 'Cat2', children: []});
    const cat31 = new Category({id: 5, name: 'Cat3.1', children: []});
    const cat321 = new Category({id: 6, name: 'Cat3.2.1', children: []});
    const cat322 = new Category({id: 7, name: 'Cat3.2.2', children: []});
    const cat323 = new Category({id: 8, name: 'Cat3.2.3', children: []});
    const cat32 = new Category({id: 9, name: 'Cat3.2', children: [cat321, cat322, cat323]});
    const cat33 = new Category({id: 10, name: 'Cat3.3', children: []});
    const cat3 = new Category({id: 11, name: 'Cat3', children: [cat31, cat32, cat33]});
