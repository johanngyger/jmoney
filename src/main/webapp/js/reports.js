...
function BalancesController($scope, $http, $filter) {
    $scope.generate = function () {
        ...
        $http.get('rest/reports/balances', {params:{date:dateParam}}).success(function (data) {
            $scope.balances = data;
        });
    }
...
function CashFlowController($scope, $http, $filter) {
    $scope.generate = function () {
        ...
        $http.get('rest/reports/cash-flows', {params:{fromDate:fromDateParam, toDate:toDateParam}}).success(function (data) {
